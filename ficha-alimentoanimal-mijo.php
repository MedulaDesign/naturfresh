...
<head>
	<title>Mijo &ndash; Mijo &ndash;<?php echo $nombreMarca; ?></title>
		...
		<article>
			<header>
				<div class="caluga verde">
					<div class="tipoA">
						<h1>MIJO</h1>
						<p>Semilla importada por NaturFresh desde Argentina para cubrir la demanda del mercado nacional.<br>
						</p>
					</div>
				</div>
				<div class="muestraCategoria"><img src="imgs/mijo546x232.jpg" alt="Mijo"></div>
			</header>
			...
			<h2>Description</h2>
			<figure>
				<img src="imgs/mijo-150x205.jpg" alt="">
				<figcaption>
				  Mijo</figcaption>
			<p class="vermas">cotizar</p>
			</figure>
			<p class="bajada">Estas semillas tienen un alto valor nutricional con importantes nutrientes para la dieta de las aves. <br>
			</p>
			<p>Semillas destinada al consumo animal, en especial las aves.<br>
			</p>
