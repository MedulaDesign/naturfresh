...
<head>
	<title>Cumin &ndash; Species &ndash;<?php echo $nombreMarca; ?></title>
	...
	<div class="corporis">
		<article>
			<header>
				...
				<div class="muestraCategoria"><img src="imgs/comino-546x232.jpg" alt="Comino"></div>
			</header>
			...
			<h2>Description</h2>
			<figure>
				<img src="imgs/productos/comino-150x205.jpg" alt="">
				<figcaption>
					Cumin</figcaption>
			...
			<h2>Recipe <br>
  (Meat with cumin/serves 4) </h2>
<h3>Ingredients:</h3>
<ul class= "ingredientes">
		  <li>500 g. <?=lorem::get(6)?><br>
	      </li>
		  <li>1 <?=lorem::get(6)?>e<br>
	      </li>
		  <li>4 <?=lorem::get(6)?><br>
	      </li>
		  <li>1 <?=lorem::get(6)?><br>
