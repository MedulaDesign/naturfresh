<header>
				...
				<div class="muestraCategoria"><img src="imgs/aceite546x232.jpg" alt="Porotos negros y otras legumbres."></div>
			</header>
		...
		<ul class="listaProductos">
			<li><a href="ficha-aceite-soya-maravilla.php">
					<h3>SOYA OIL</h3>
					<p>&nbsp;</p>

					<img src="imgs/oil-94x128.jpg">
